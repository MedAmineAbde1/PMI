...
int main(void)
{
    ...
    TIM2 -> PSC = 1599; //clock f=16 MHz |timer_f (16.000.000/PSC+1) and counts in range(0,ARR) in frequenz von timer_f
    TIM2 -> ARR = 10000;
...
void USART2_IRQHandler(void)
{
    ...
    uart_irq_tx_str(rx_buf); //Gibt rx_buf aus (zum testen)
}